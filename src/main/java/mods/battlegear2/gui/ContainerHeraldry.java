...
public class ContainerHeraldry extends ContainerLocalPlayer {
    ...
    public ContainerHeraldry(InventoryPlayer inventoryPlayer, boolean local, EntityPlayer player) {
        ...
        this.addSlotToContainer(new HeraldrySlot(inventoryPlayer, OFFSET + EXTRA_ITEMS + 1, -40, -22));
        this.addSlotToContainer(new HeraldrySlot(inventoryPlayer, OFFSET + EXTRA_ITEMS + 2, -20, -22));
        this.addSlotToContainer(new HeraldrySlot(inventoryPlayer, OFFSET + EXTRA_ITEMS + 3, 0, -22));
        // Default bar
        for (int i = 0; i < 9; ++i) {
