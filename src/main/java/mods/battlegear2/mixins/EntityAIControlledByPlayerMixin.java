...
public abstract class EntityAIControlledByPlayerMixin {
    ...
    @Redirect(method = "updateTask", at = @At(value = "FIELD", target = "Lnet/minecraft/entity/player/InventoryPlayer;mainInventory:[Lnet/minecraft/item/ItemStack;", opcode = GETFIELD, args = "array=set"))
